...
public class TheFlyingCat extends JFrame {
	...
	private Image bar = new ImageIcon(Main.class.getResource("../images/bar.png")).getImage();
	...
	public TheFlyingCat() {
		...
		//bar.setBounds(520, 650, 230, 30); // x축,y축,가로크기,세로크기
	...
	public void screenDraw(Graphics g) {
		...
		if(isGameScreen) {
			...
			g.drawImage(bar, bar_x, bar_y, null);
